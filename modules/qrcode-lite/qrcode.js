/*
 * SPDX-FileCopyrightText: 2018 zeekay <https://github.com/zeekay/qrcode-lite>
...
function buildSingleSegment (data, modesHint) {
  ...
  if (mode !== BYTE$1 && mode.bit < bestMode.bit) {
    throw new Error('"' + data + '"' +
      ' cannot be encoded with mode ' + toString$1(mode) +
      '.\n Suggested mode is: ' + toString$1(bestMode))
  }
