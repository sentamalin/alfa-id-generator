...
/** `EventsMRVB` describes an ALFA Furry Events Visa in the MRV-B
 *  document size with a visible digital seal (VDS). Its smaller size
 *  allows it to be used in furry events passports that require a clear
 *  area aside the visa sticker. Justifications for this are because
 *  the passport number is perforated or printed on the pages, or the
 *  issuing authority wants to place a seal or mark that overlaps the visa
 *  sticker and the passport page. Due to its smaller dimensions, less
 *  data can fit on the visa sticker compared to a MRV-A visa.
 * 
 * @mixes MRVBDocument
 * @mixes DigitalSealV4
 */
