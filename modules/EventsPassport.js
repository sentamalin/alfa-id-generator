 ...
 *  machine-readable travel document (MRTD) in the form of a booklet with
 *  a visible digital seal (VDS). In addition to the machine-readable
 *  passport (MRP) page and signature page, it contains pages where furries
 *  can affix event visas from furry events they've attended (like conventions)
 *  and other items/memorabilia like stamps, autographs, or stickers.
 * 
 * @mixes TD3Document
 * @mixes DigitalSealV4
 */
class EventsPassport {
   ...
   * @param { string } [opt.placeOfBirth] - Location of the document holder's birth.
   ...
   * @param { string } [opt.endorsements] - Endorsements, annotations, or other notes about this document.
