...
class DigitalSealV3 {
   ...
   * @param { number[] } [opt.signatureData] - The raw signature data generated by concatenating the header and message zone, hashing the result, and signing the hash with a cryptographic key.
  ...
  constructor(opt) {
    if (opt) {
      ...
      if (opt.signatureData) { this.signatureData = opt.signatureData; }
  ...
  /* The mixins `DigitalSealV3` mixes. */
