 ...
 *     (VDS). The size of a credit card, this identification document shows a
 *     furry is privileged to perform a specific function granted by an issuing
 *     authority. Example privileges are driving vehicles on land, on sea, or in
 *     the air; or possessing the competency to carry and operate specific
 *     items.
 */
class CrewLicense {
  /**
   * Create a `CrewLicense`.
   ...
   * @param { string } [opt.privilege] - The title or description of the
   *     privilege granted by the issuing (sub)authority.
   * @param { string } [opt.ratings] - A notation regarding any authorizations
   *     beyond the granted privilege--like specific aircraft types.
   * @param { string } [opt.limitations] - A notation regarding any restrictions
   *     that would otherwise be granted with the granted privilege or ratings.
   ...
   *     long.
   * @param { string } [opt.privilegeCode] - A hex string up to 8 characters
   *     long.
   */
  constructor(opt) {
    ...
    this.privilegeCode = opt?.privilegeCode ?? "0";
  ...
  // The objects `CrewLicense` uses to compose itself.
  #document;
  #seal;
  ...
  #privilege;
  /**
   * The title or description of the privilege granted by the issuing
   *     (sub)authority.
   * @type { String }
   */
  ...
  #ratings;
  /**
   * A notation regarding any authorizations beyond the granted privilege--like
  ...
  #limitations;
  /**
   * A notation regarding any restrictions that would otherwise be granted with
   *     the granted privilege or ratings.
   * @type { String }
   */
  ...
  /**
   * A hex-string defined by the issuing (sub)authority for the granted
   *     privilege.
   * @type { string }
   */
  get privilegeCode() {
