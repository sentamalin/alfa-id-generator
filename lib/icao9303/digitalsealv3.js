 ...
 *     version 3. Consult ICAO 9030 part 13 to see the differences between this
 *     version and other versions. Use of version 3 VDSs are discouraged but may
 *     still be encountered in the wild.
 * 
 * `DigitalSealV3` is intended to be used to compose different kinds of
 ...
 *     directly.
 */
export class DigitalSealV3 {
  /**
   * Create a `DigitalSealV3`.
   ...
   *     user-assigned ranges are recommended: AAA-AAZ, QMA-QZZ, XAA-XZZ, or ZZA-ZZZ.
   */
